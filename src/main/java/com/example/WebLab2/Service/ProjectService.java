...
import com.example.WebLab2.Exception.ProjectNotFoundException;
import com.example.WebLab2.Mapper.ProjectMapper;
import com.example.WebLab2.Model.Project;
import com.example.WebLab2.Repository.ProjectRepository;
...
public class ProjectService {
    ...
    public ProjectDto updateProject(Long id, ProjectDto upProject) {
        ...
        project.setStartDate(Date.from(upProject.getStartDate().atStartOfDay(ZoneId.systemDefault()).toInstant()));
        project.setEndDate(Date.from(upProject.getStartDate().atStartOfDay(ZoneId.systemDefault()).toInstant()));
